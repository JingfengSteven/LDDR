#!/bin/bash
# QFrame Strategy Evaluation Script
# Multi-scale frame selection: 4@512 + 8@128 + 32@32 tokens
...
accelerate launch --num_processes=1 --main_process_port=12342 -m lmms_eval \
    --model qwen2_5_vl_chat_w_qframe \
    ...
    --verbosity=DEBUG \
    --batch_size 1 \
    --output_path ./outputs/qwen25vl_qframe \
    --log_samples
