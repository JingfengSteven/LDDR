...
accelerate launch --num_processes=1 --main_process_port=12342 -m lmms_eval \
    ...
    --model_args=pretrained=/path/to/your/workspace/EACL/ckpt/qwen/Qwen/Qwen2.5-VL-3B-Instruct,attn_implementation=flash_attention_2,interleave_visuals=False,max_num_frames=8 \
    --tasks videomme \
    --verbosity=DEBUG \
    --batch_size 2 \
